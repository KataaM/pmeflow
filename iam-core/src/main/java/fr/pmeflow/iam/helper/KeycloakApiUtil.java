...
/**
 * Cette classe est un utilitaire racourcissant l'acces à l'api keycloak
 */
public class KeycloakApiUtil
{
    // ----------- Attribut(s) -----------
    private static final Logger log = Logger.getLogger(KeycloakApiUtil.class);
    ...
    public static ProtocolMapperRepresentation findProtocolMapperByName(ClientResource client,
            String name)
    {
    ...
    public static ClientScopeResource findClientScopeByName(RealmResource realm,
    ...
    public static UserRepresentation findUserByUsername(RealmResource realm, String username)
    {
        ...
        List<UserRepresentation> ur = realm.users().search(username, null, null, null, 0,
                Integer.MAX_VALUE);
        if (ur.size() == 1)
        {
            user = ur.get(0);
    ...
    public static UserResource findUserByUsernameId(RealmResource realm, String username)
    {
        ...
        return user!=null?realm.users().get(user.getId()):null;
    }
     ...
     * @return ID of the new user
     */
    public static String createUserAndResetPasswordWithAdminClient(RealmResource realm,
            UserRepresentation user, String password)
    {
     ...
     */
    public static String createUserAndResetPasswordWithAdminClient(RealmResource realm,
            UserRepresentation user, String password, boolean temporary)
    {
    ...
    public static void resetUserPassword(UserResource userResource, String newPassword,
            boolean temporary)
    {
    ...
    public static void assignClientRoles(RealmResource realm, String userId, String clientName,
            String... roles)
    {
        String realmName = realm.toRepresentation().getRealm();
        String clientId = "";
    ...
    public static boolean groupContainsSubgroup(GroupRepresentation group,
    ...
    public static AuthorizationResource findAuthorizationSettings(RealmResource realm,
            String clientId)
    {
        for (ClientRepresentation c : realm.clients().findAll())
        {
    ...
    public static KeysMetadataRepresentation.KeyMetadataRepresentation findActiveKey(
            RealmResource realm)
    {
